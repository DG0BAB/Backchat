...
public typealias NetworkServiceResponse = (Data, HTTPURLResponse)
...
public protocol NetworkService {
	...
	typealias TokenHook = (Bool) async -> String?
	 ...
	 */
	func sendRequest(_ request: URLRequest) async throws -> NetworkServiceResponse
}
